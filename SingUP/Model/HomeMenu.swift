...
var homeMenus : [HomeMenu] = [
    ...
    HomeMenu(title : "Vocal Exercies", path : "exercise", image : "VocalExercise", description : "Get your voice ready with quick and easy vocal exercise to sing better, stronger, and safer.", color : Color("RedExerciseCard")),
