...
struct SustainCompleted: View {
    ...
    var body: some View {
        VStack(spacing: 30) {
            ...
            Text("You’ve completed your Sustain note exercise with steady breath control.")
            ...
            VStack(spacing: 10) {
                ...
                Button(action: {
                    ...
                    Label("re-test Vocal Sustain Training", systemImage: "arrow.counterclockwise")
        ...
        .onAppear {
            ...
            history?.store(date: Date(), exercise: 1, accuracy: randomAccuracy)
            print("Store")
        }
